const welcomeLayout = (person, insurance) => {
	return `
	...
	<!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr style="line-height:0px"><td style="padding-right: 0px;padding-left: 0px;" align="left"><![endif]--><img alt="Image" border="0" class="left fixedwidth" src="http://segumundo.com.ec/wp-content/uploads/2017/05/logo-segumundo.png" style="text-decoration: none; -ms-interpolation-mode: bicubic; border: 0; height: auto; width: 100%; max-width: 155px; display: block;" title="Image" width="155"/>
	...
	<p style="font-size: 12px; line-height: 1.2; text-align: right; mso-line-height-alt: 14px; margin: 0;"><span style="font-size: 12px;">Te ayudamos a asegurar lo que te importa.</span></p>
	</div>
	</div>
	<!--[if mso]></td></tr></table><![endif]-->
	<!--[if (!mso)&(!IE)]><!-->
	...
	<p style="font-size: 14px; line-height: 1.2; mso-line-height-alt: 17px; margin: 0;"><strong><span style="font-size: 46px;">Bienvenid@, <span style="color: #3d3bee; font-size: 46px;">${person.first_name} ${person.last_name}</span>!</span></strong></p>
	</div>
	</div>
	<!--[if mso]></td></tr></table><![endif]-->
	...
	<p style="font-size: 12px; line-height: 1.5; mso-line-height-alt: 18px; margin: 0;"><strong><span style="font-size: 20px;">Gracias por elegir los servicios de <bold>SEGUMUNDO</bold>.</span></strong></p>
	</div>
	</div>
	<!--[if mso]></td></tr></table><![endif]-->
	...
	<div style="font-size: 12px; line-height: 1.2; text-align: center; font-family: 'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif; color: #444444; mso-line-height-alt: 14px;">
	<p style="font-size: 14px; line-height: 1.2; mso-line-height-alt: 17px; margin: 0;"><span style="background-color: #FFFFFF; font-size: 14px;"><span style="font-size: 24px; background-color: #FFFFFF;"><span style="font-size: 24px; background-color: #FFFFFF;"> Nuestros Productos: </span></span></span></p>
	</div>
	</div>
	<!--[if mso]></td></tr></table><![endif]-->
    ...
    <a href="http://segumundo.com.ec/">
    <ul style="font-size: 12px;">
    <li style="font-size: 16px; line-height: 1.8; mso-line-height-alt: 29px;"><span style="font-size: 16px;">Seguro de Vida. </span></li>
    <span style="font-size: 16px;"><img src="http://segumundo.com.ec/wp-content/uploads/2017/03/segvida.png"></span>
    <li style="font-size: 16px; line-height: 1.8; mso-line-height-alt: 29px;"><span style="font-size: 16px;">Seguro de Educación. </span></li>
    <span style="font-size: 16px;"><img src="http://segumundo.com.ec/wp-content/uploads/2017/03/profes.jpg"></span>
    <li style="font-size: 16px; line-height: 1.8; mso-line-height-alt: 29px;"><span style="font-size: 16px;">Seguro de Jubilación.</span></li>
    <span style="font-size: 16px;"><img src="http://segumundo.com.ec/wp-content/uploads/2017/03/segjbu.jpg"></span>
    </ul>
    </a>
	</div>
	</div>
	...
	<p style="font-size: 14px; line-height: 1.5; text-align: center; mso-line-height-alt: 21px; margin: 0;"><span style="color: #000000; font-size: 14px;"><strong>Segumundo S.A.</strong></span>, creando experiencias.</p>
	<p style="font-size: 14px; line-height: 1.5; text-align: center; mso-line-height-alt: 21px; margin: 0;">Av. Benjamín Carrión, Edif City Office Plaza Of 627
        Guayaquil   </p>
    <p style="font-size: 14px; line-height: 1.5; text-align: center; mso-line-height-alt: 21px; margin: 0;" >Teléfono: +593 4-295-9554</p>
	</div>
	</div>
	<!--[if mso]></td></tr></table><![endif]-->
	...
	<td style="word-break: break-word; vertical-align: top; padding-bottom: 5px; padding-right: 3px; padding-left: 3px;" valign="top"><a href="http://facebook.com/Segumundo/" target="_blank"><img alt="Facebook" height="32" src="https://icon-library.net/images/facebook-icon-50x50/facebook-icon-50x50-21.jpg" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: none; display: block;" title="Facebook" width="32"/></a></td>
	</tr>
	</tbody>
	</table>
	</td>
